...
require_once( '../../_function.php');
	...
	session_start();
	$fiche = listeFicheparNbrActions($_SESSION['id']);
if($fiche != false ):
foreach($fiche as $f):
			...
			echo('<tr>
				...
				<td class="tdIcone">
					 ...
					 <input type="image" src="../images/modifier.png" style=" float:left; border: none; height: 35px; width: 32px; box-shadow: none;margin-left: 35px;" name="ConsulterActionVisiteur" class="consulter" value="'. $f['id'].'"/>
