...
foreach($fiche as $f):
			...
			echo('<tr>
				...
				<td>
					...
					<input class="modification" style="width: 170px;" type="text" value="'.$f['NomSociete'].'" name="NomSociete'.$f['id'].'" />
				...
				<td class="tdIcone">
					...
					<img onclick="SupprimerFicheConsulterFiche('. $f['id'].')" name="supprimerFiche" style=" border: none; height: 35px; width: 32px; box-shadow: none;margin-left: 35px;" src="../images/supprimer.png" value="'. $f['id'].'"/>
