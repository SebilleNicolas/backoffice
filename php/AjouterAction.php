	...
	**/
		...
		// if( count($ListeRappelTechnicien) =0)
		// { ListeRappelTechnicien
		...
		if(!empty($_POST['SelectionnerInterlocuteur']) && !empty($_POST['ContenuTextDescription']))
		{
		
		
		$idFiche = $_POST['EnregisterAction'];
		...
		$ListeSujet =  $_POST['SelectSujet'];

		if(!empty($_POST['ListeMotifs']))
		{	$ListeMotifs =  $_POST['ListeMotifs'];	}
		else
		{	$ListeMotifs = null;	}
		
			$SelectionnerInterlocuteur =  $_POST['SelectionnerInterlocuteur'];	
	
		
		
		if($ContenuTextDescription != ""  && $SelectTechnicien != 0 && $idFiche != 0)
		{
		
		$res = enregistrerActions($IdAction,$idFiche,$IdUtilisateur,$NouveauNumero,$DateDeb,$HeureDeb,$MinuteDeb,$DureeEnJour,$TempsAction,$DateFin,$HeureFin,
		$MinuteFin,$SelectTechnicien,$SelectType,$SelectCategorie,$SelectionnerInterlocuteur,$ListeEPAOngletDescription,$ContenuTextDescription,$ContenuTextSolution,$ListeMotifs,$ListeSujet);	
		// var_dump($res);
		if($res == true)
		{
		$message='Vous venez d\'ajouter votre action !';

		echo '<script type="text/javascript">window.alert("'.$message.'");
		document.location.href = "./ConsulterFiche.php";
		</script>';
		...
		// var_dump($_POST['ContenuTextSolution'],$_POST['ContenuTextDescription']);
	...
	<div class="contenu">
		...
		<form method="POST" name="FormEnregistrer" > <!--action="AjouterAction.php?id=$id"-->
		<tr>
				<td>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input type="text" id="Numero" style="width: 220px;" name="NouveauNumero" class="modification" value="<?php echo $IdAction; ?>" />
						...
						<td>
							...
							<input type="date" value="<?php echo date("Y-m-d" ); ?>" class="modification" name="DateDeb" style="width: 140px;" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date_format(date_sub(new DateTime(date('Y-m-d')), new DateInterval('P1Y')), 'Y-m-d'); ?>" />
						...
						// <script>
							...
							<input type="number" style="width:35px;" min="0" max="23" pattern="[0-9]{1,3}"  name="HeureDeb" value="<?php echo date("H"); ?>"/> :
							
							<input type="number" style="width:35px;" min="0" max="59" pattern="[0-9]{1,3}"  name="MinuteDeb" value="<?php echo date("i"); ?>"/>
						 
						</td>
						
					<td>
					
						<input type="number" id="CompteurJour" min="0"  pattern="[0-9]" style="width: 50px;" name="DureeEnJour" value="0"/>
						
					</td>
					<td>
						
							<input id="Compteur" type="text" value= "00 : 00 : 00"  style="width:75px;"  name="TempsAction" class="modification" />
						
						</td>
						<td>
						
							<input type="checkbox" id = "Cloture" class="CheckBox" name="ClotureAction" value="">Action Cloturer<br>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input type="date" value="" id="DateFin" class="modification" name="DateFin" style="width: 140px;"  />
						
						</td>
						
						<td>
						
							<input type="number" style="width:35px;" min="0" max="23" pattern="[0-9]{1,3}"  id="HeureFin" name="HeureFin" value=""/> :
							<input type="number"  style="width:35px;" min="0" max="59" pattern="[0-9]{1,3}"  id="MinuteFin" name="MinuteFin" value=""/>
		...
		<select name="SelectTechnicien">
			<?php include 'ListeTechnicien.php'?>
					...
					?>
					  <option value="<?php  echo $ListeType[$i][0];?>"><?php  echo $ListeType[$i][1]; ?></option>
					  <?php } ?>
					</select>
					...
					?>
					  <option value="<?php  echo $ListeCategorie[$i][0];?>"><?php  echo $ListeCategorie[$i][1]; ?></option>
					  <?php } ?>
					</select>
				...
				<td>
				<select id="SelectInterlocuteur" name="SelectionnerInterlocuteur">
					...
					?>
					  <option id="OptionInter" value="<?php  echo $ListeInterocuteur[$i][0];?>" 
					  <?php if(isset($_GET['IdInter'])):
					  if($_GET['IdInter'] != ""):
					  if($ListeInterocuteur[$i][0] == $_GET['IdInter']):
					  
					  ?>  selected <?php endif; endif; endif; ?> ><?php  echo $ListeInterocuteur[$i][2];echo "  ".$ListeInterocuteur[$i][3]; ?></option>
					  <?php } ?>
					</select>
	...
	?>
				...
				<tr id="Interlocuteur">
					...
					<td class="tdIcone">
						...
						<img type="submit" name="supprimerI" style="float: none; border: none; height: 35px; width: 32px; box-shadow: none;" src="../images/supprimer.png"  onclick="SupprimerInter(this.form.elements['SelectionnerInterlocuteur'].name,øø)" value=''/>
					
					</td>
					<!--style="float: none;"-->
						<td>	
							<img value="" class="reporter"  style="float: none;" name="ModifierI">
						</td>
						<td >
...
<thead class="thead">
		...
		<tr>
					...
					<th>
						...
						<?php for ($i = 0; $i < count($ListeEPA); $i++){ ?>
						  ...
						  <option value="<?php  echo $ListeEPA[$i][0]; ?>">
	...
	<tbody>
			<td>
					...
					<textarea class="Description" style="resize: none;"  name="ContenuTextDescription"></textarea>
					</div>
			</td>
			<td>
			...
			<td>
					...
					<textarea class="Description" style="resize: none;" name="ContenuTextSolution"></textarea>
					</div>
	...
	<div class="contenu_onglet" id="contenu_onglet_RappelRelances">
		...
		<table  style="border: none; margin-left: 100px;width: 85%;">
		<tr>
		...
		Rappel Technicien :
			...
			Ajouter Rappel Technicien :  <img  id="ButAjouterRelanceTechni" name="AjouterdRelanceTechni" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 10px;" src="../images/ajouter.png"  value=''/>
			</td>
		<td class = "espace">
		</td>
		...
		<!--2e Ligne )==> Petit tableau Rappel Technicien-->
			<tr>
						...
						?>
							<tr>
								<td>
									...
									<input class="modification" type="text" disabled="disabled" value="<?php   echo $RT['IdRelanceTechni']; ?>" name="IdRelanceTechni<?php   echo $RT['IdRelanceTechni']; ?>" disabled />
								
								</td>
								<td>
								<input  disabled="disabled" type="date" value="<?php echo $RT['DateRelanceTechni']; ?>" class="modification" name="DateRelanceTechni" style="width: 130px;" />
						...
						<?php include 'ListeTypeRelanceTechni.php'; ?>
							</select> 
								</td>
								<td>
								
								<img name="supRT" onclick="SupprimerRelanceTechni(<?php echo $RT['IdRelanceTechni'];  ?>)" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 10px;" src="../images/supprimer.png" value='<?php echo $RT['IdRelanceTechni'];  ?>'/>
								
								</td>
								<td>
								<input type="radio" name="SelectCommentaire" style="float: none; " onclick="chargeCommentaire(<?php echo $RT['IdRelanceTechni'];  ?>)" value="<?php echo $RT['IdRelanceTechni'];  ?>"><br>
	...
	<table style="border: none; margin-left: 100px;" >
		<tr>
		...
		Relance Client :
			...
			Ajouter Relance Client :  <img  id="ButAjouterRelanceClient" name="AjouterdRelanceClient" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 10px;" src="../images/ajouter.png" value=''/>
			</td>
		<td class = "espace">
		</td>
		...
		<!--2e Ligne )==> Petit tableau Rappel Technicien-->
			...
			<?php foreach($ListeRelanceClient as $RC):	?>
				<tr>
								...
								<td>
								<input disabled="disabled" type="date" value="<?php echo $RC['DateRelanceCli']; ?>" class="modification" name="DateRelanceTechni" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date_format(date_sub(new DateTime(date('Y-m-d')), new DateInterval('P1Y')), 'Y-m-d'); ?>" />
								<!--<input class="modification" type="text" value="" name="DateRelanceTechni<?php// echo $f['id']; ?>" />-->
								</td>
								<td>
						...
						<?php include 'ListeTypeDemandeRelanceClient.php'; ?>
								...
								<img name="supRT" onclick="SupprimerRelanceClient(<?php echo $RC['IdRelanceClient'];  ?>)" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 57px;" src="../images/supprimer.png" value='<?php echo $RC['IdRelanceClient'];  ?>'/>
	...
	<h2> Ajouter un nouveau numero de serie</h2>
		...
		<table class="RappelRelanceClient">
			...
			<tbody>
			<td>
			<table class="ficheCourante" style="margin-top: 0;">
			<thead class="thead" align="center">
				<th>
					IdNumSerie
				</th>
			...
			<tr> <td></td>
				<td>
						...
						<input class="modification" id="NouveauNumSerieLogi" style="width: 130px;" type="text" value="" />
					...
					<td class="tdicone">
							...
							<img  id="AjouterNumSerieLogi" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 10px;" src="../images/ajouter.png"  />
			...
			<td>
				<input class="modification"   type="text" value="'.$ma['NumeroSerie'].'" disabled/>
					...
					<td class="tdicone">
						...
						<img  onclick="SupprimerNumSerieMater('.$ma['IdNumSerie'].')" style="float: none; border: none; height:  35px; width: 33px; box-shadow: none; margin-left: 10px;" src="../images/supprimer.png" value="" />
	...
	endforeach;  ?>
			...
			<td></td>
				<td>
						...
						<input class="modification"   style="width: 130px;" id="NouveauNumSerieMater" type="text" value=""/>
					...
					<td class="tdicone">
							...
							<img  id="AjouterNumSerieMater" style="float: none; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 10px;" src="../images/ajouter.png"  />
	...
	<td class="tdicone">
							...
							<img   id="AjouterSujet" style="float: left; border: none; height: 30px; width: 27px; box-shadow: none; margin-left: 57px;" src="../images/ajouter.png"  />
